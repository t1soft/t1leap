...
#Region "File"
    ...
    Private Sub ColunmToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ColunmToolStripMenuItem.Click
        If Edited = True Then
    ...
    Private Sub ColunmToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles ColunmToolStripMenuItem1.Click
        If Edited = True Then
            Dim result As DialogResult = MessageBox.Show("Document has been Modified, Do you Want to Save?", "Question", MessageBoxButtons.YesNoCancel)
            If result = DialogResult.Cancel Then
            ElseIf result = DialogResult.No Then
    ...
    Private Sub ColunmToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles ColunmToolStripMenuItem2.Click
        If Edited = True Then
            Dim result As DialogResult = MessageBox.Show("Document has been Modified, Do you Want to Save?", "Question", MessageBoxButtons.YesNoCancel)
            If result = DialogResult.Cancel Then
            ElseIf result = DialogResult.No Then
    ...
    Private Sub ColunmToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles ColunmToolStripMenuItem3.Click
        If Edited = True Then
            Dim result As DialogResult = MessageBox.Show("Document has been Modified, Do you Want to Save?", "Question", MessageBoxButtons.YesNoCancel)
            If result = DialogResult.Cancel Then
            ElseIf result = DialogResult.No Then
    ...
    Private Sub ColunmToolStripMenuItem4_Click(sender As Object, e As EventArgs) Handles ColunmToolStripMenuItem4.Click
        If Edited = True Then
            Dim result As DialogResult = MessageBox.Show("Document has been Modified, Do you Want to Save?", "Question", MessageBoxButtons.YesNoCancel)
            If result = DialogResult.Cancel Then
            ElseIf result = DialogResult.No Then
    ...
    Private Sub openbutton1_Click(sender As Object, e As EventArgs) Handles openbutton1.Click
        If Edited = True Then
            ...
            If result = DialogResult.Cancel Then
            ElseIf result = DialogResult.No Then
                open_dialog1.Filter = "t1leaptable Documents|*.tdsf"
                If open_dialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub documentBox_TextChanged(sender As Object, e As EventArgs)
        Edited = True
    End Sub
    ...
    Private Sub savebutton1_Click(sender As Object, e As EventArgs) Handles savebutton1.Click
        ...
        Else
            save_dialog1.Filter = "t1leaptable Documents|*.tdsf"
